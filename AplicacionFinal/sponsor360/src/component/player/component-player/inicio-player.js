...
function InicioPlayer (){
    ...
    <div >
     ...
     <div className="box-c">
        ...
        <div className="card-c cblue-c cw2-c ">
            ...
            <div className="box-c text-vertical-center-c m0-c">
           <h2 className=' text-vertical-center-c text-light '> <i class="icon ion-logo-twitter blue-textcolor-c"></i> @pablo  <p className=' '>350   </p></h2>
           
            </div>
            <hr/>
            <div className="box-c text-vertical-center-c m0-c">
           <h2 className=' text-vertical-center-c text-light'> <i class="icon ion-logo-instagram blue-textcolor-c"></i> @pablo</h2>
            <p className=' '>350  </p>
            </div>
            <hr/>
            <div className="box-c text-vertical-center-c m0-c">
           <h2 className=' text-vertical-center-c text-light'> <i class="icon ion-logo-facebook blue-textcolor-c"></i> @pablo</h2>
            <p className=' '>350  </p>
            </div>
            <hr/>
        </div>
    ...
    <div className="box-c">
        <div className="card-c cblack-c cw2-c ">
            ...
            <div className="box-c text-vertical-center-c">
