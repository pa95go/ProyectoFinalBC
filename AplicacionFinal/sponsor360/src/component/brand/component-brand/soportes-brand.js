            ...
            <div >
                <ListMisSoportes soportes = {soportes} setSoportes= {setSoportes}/>
                        {/* <div className="box-c">
                            ...
                            <img className='img-mini-profile-black-c' src='https://i.pinimg.com/736x/01/29/66/012966f0b8950ee8e67fa87f315d8eff.jpg'  />
                            </div>


                            <div className="cw50-c text-vertical-center-c">
                            <h3 className=' m0-c text-bolder  '>CAMISETA DELANTERA </h3>
                            <h4 className=' m0-c text-light  '>Lorem ipsum dolor sit amet, consectetur adipisicing elituta!SLorem ipsum dolor sit amet, consectetur adipisicing elituta!S</h4>
                            <p className=' text-bolder m0-c  '><i class="icon ion-md-calendar "></i> 30/25/1995 - 88/22/2022 </p>
                            <p className=' text-bolder m0-c '><i class="icon ion-md-expand "></i> 35cm x 65cm</p>
                        
                            </div>
                        <div className="cw30-c">
                            
                            <button className=" p0-c box-noresponsive-c justify-end btn-enlace-c">
                            <p className='text-vertical-center-c ' >PABLO GÓMEZ OSUNA &nbsp;&nbsp;</p>
                             <h2 className='m0-c text-vertical-center-c'> <img className='img-xs-profile-blue-c ' src='https://cdn2.vectorstock.com/i/thumb-large/63/66/profile-placeholder-default-avatar-vector-21666366.jpg ' /></h2>
                            </button>
