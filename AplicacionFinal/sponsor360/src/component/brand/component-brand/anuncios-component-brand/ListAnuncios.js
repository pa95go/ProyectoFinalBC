             ...
             anuncios.map((anuncio, index)=>{
                ...
                <div className="card-c black-c cw2-responsive-c d-inline m3-b ">
                    ...
                    <div >
                        ...
                        <p className='ctcenter-c text-light m0-c'>{anuncio.descripcion}. </p>
                        <div className="mt10-c">

                        <h3 className='ctcenter-c text-bolder m0-c red-textcolor-c  '><i class="icon ion-md-ca2sh "></i> {anuncio.precio} €/año </h3>
                        </div>
                        ...
                        <button className='btn-red-c text-m text-bold mt15-c   '>Comprar</button>
